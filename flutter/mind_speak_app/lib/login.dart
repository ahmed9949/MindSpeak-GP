...
class _LogInState extends State<LogIn> {
  ...
  try {
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const Home())); // Consider using pushReplacement to avoid back navigation to login screen.
